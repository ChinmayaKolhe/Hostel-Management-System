...
$(document).ready(function() {
    $('#duration').change(function(){
        var duration = parseInt($(this).val()); // Get the selected duration
        var feesPerMonth = parseFloat($('#fpm').val()); // Get the fees per month
        var totalAmount = duration * feesPerMonth; // Calculate the total amount
        
        // Set the calculated total amount in the total amount input field
        $('#ta').val(totalAmount.toFixed(2)); //toFixed(2) to round to 2 decimal places
    });
});
</script>
